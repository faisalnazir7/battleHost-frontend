      ...
      <div className="RegisterTournament">
        <div className="tournament p-5">
          ...
          <div className="tournament_header md:flex mt-4 block text-center">
            <h1 className=" mt-8 md:ml-16 font-bold text-4xl m-auto mb-6 md:mb-0">
              {tournament?.name}
            </h1>
            ...
            Date.now() <= new Date(tournament.endDateTime) ? (
              <button
          ...
          <div className="md:shadow-2xl shadow-xl md:w-3/12 md:h-80 w-full h-full mt-8 border-2 rounded-xl pl-4 pt-1 ml-auto mr-12">
            <h2 className="font-bold text-2xl mt-6 text-center text-green-500">
              Application Date
            </h2>
            <p className="font-bold flex text-lg mt-8 ">
              ...
              &nbsp;From <br />
              {dateFormatter(tournament?.startDateTime, 0)}
            </p>
...
{' '}&nbsp;Till {dateFormatter(tournament?.endDateTime,0)}
              ...
              <p className="font-bold text-lg md:mt-16 mt-4 italic text-red-500">
                Already {tournament?.participants.length} Participants have
        ...
        <div className="py-6">
          <button
            ...
            onClick={() =>
              navigator(`/tournaments/details/${tournamentId}/result`)
            }
          >
