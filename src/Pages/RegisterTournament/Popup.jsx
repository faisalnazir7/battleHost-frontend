  ...
  const registerTournament = async () => {
    try {
      ...
      const response = await fetch(
        ...
        }/api/tournament/registerfortournament`,
        {
          method: "POST",
          headers: {
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="text-center p-8">
                  ...
                  {Individual ? (
                    <>
                      <p className="text-m italic my-4 text-center md:ml-8 md:w-96">
                    ...
                    <>
                      <p className="text-m italic my-4 md:ml-8 md:w-96">
                      ...
                      <h2 className="text-2xl text-center mt-3 font-semibold text-red-400">
                        Team Registration
                      </h2>
                      <p className="italic md:w-96 text-start mt-8 ">
                        <span className="font-bold">Note: </span> The person
                        registering will automatically be considered as the team
                        leader.
                      </p>
                    </>
                  )}
              ...
              />*/}
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  {Individual ? (
                    <p className="text-center mt-2 block md:flex">
                      Participate as a Team?{" "}
                      <span
                        className="text-sky-400 cursor-pointer hover:underline block md:flex"
                        onClick={() => {
                          setIndividual(false);
                          setTypeReg("team");
                        }}
                    ...
                    <p className="text-center mt-2 mr-8 block md:flex">
                      Participate solo?{" "}
                      <span
                        className="text-sky-400 cursor-pointer hover:underline block md:flex"
                        onClick={() => {
