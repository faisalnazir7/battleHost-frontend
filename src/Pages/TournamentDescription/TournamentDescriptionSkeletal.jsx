      ...
      <div className="RegisterTournament">
        <div className="tournament p-5">
          ...
          <div className="tournament_header md:flex mt-4 block text-center">
            ...
            <Skeleton className="rounded-xl w-72 mt-2 md:mr-4  md:ml-auto  p-5 md:text-xl text-lg tracking-wide font-semibold  shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2" />
          </div>
          <div className="md:shadow-2xl shadow-xl md:w-80 md:h-80 w-full h-full mt-8 rounded-xl ml-auto p-0">
            <Skeleton
              height={"100%"}
              width={"100%"}
              className="md:shadow-2xl shadow-xl md:w-80 md:h-80 w-full h-full mt-8 border-2 rounded-xl ml-auto p-0"
            />
          </div>
          <div className="md:ml-12 md:-mt-80 m-auto mt-4">
            ...
            <div className="positions mt-6">
              <Skeleton className="text-2xl font-semibold text-center md:text-left" />
              <div className="prizes_display md:flex block"></div>
            </div>
          </div>
        </div>
        <div className="py-6">
          <Skeleton className="rounded-md p-5 w-36 text-white text-xl flex m-auto" />
        </div>
      </div>
    </>
  );
