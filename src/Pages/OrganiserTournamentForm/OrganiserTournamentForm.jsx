...
export default function OrganiserTournamentForm() {
  const categories = ["Tournament", "Hackathon", "Event"];
  ...
  const createTournament = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_SERVER_URL}/api/tournament/createtournament`,
        {
          method: "POST",
          headers: {
      ...
      <div className="OrganiserTournamentForm bg-white m-auto w-9/12 md:w-1/2 mt-8 mb-24">
        ...
        >
          <div className="space-y-12">
            <div>
              <h2 className="text-xl md:text-3xl font-bold leading-tight text-black sm:text-4xl">
                Create your own Tournamnet
              </h2>
...
></input>*/}
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            ...
            {!isLoading ? (
              ...
              >
                <Waveform size={20} lineWeight={3.5} speed={1} color="white" />
              </button>
            )}
          </div>
        </form>
