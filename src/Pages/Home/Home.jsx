...
export default function Home() {
  ...
  return (
    ...
    <button className='text-3xl ml-16 mt-16 text-red-600 rounded-[2rem] border-2 w-60 h-20 bg-[#ffe4c4] font-semibold hover:bg-[#ffd1a0] shadow-md border-orange-500 transform hover:translate-y-[-5px] transition-transform duration-100'>Register Now</button>
