        ...
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="flex flex-col px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
            ...
            <p className="mt-8 text-lg text-gray-700">
              This platform offers you to showcase your skills and prove
              yourself. Join Competition,Tournaments and many more Contests!
            </p>
        ...
        <div className="grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600">
              Meet other talented developers and get your foot in the door of
              the tech industry. Build your network and make connections that
          ...
          <div>
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-blue-100">
              <img
                src={img2}
                className="h-15 w-15 text-blue-600"
                viewBox="0 0 24 24"
                stroke="currentColor"
              />
            </div>
            ...
            <p className="mt-4 text-sm text-gray-600">
              ...
              Meetup with other participants and collaborate on projects. Learn
              from the best and get inspired
            </p>
          </div>
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600">
              Win cash prizes, scholarships, and other amazing prizes!
              Scholarships to top universities. Other amazing prizes, such as
              laptops, drones, and more!
            </p>
          </div>
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600">
              Have a great time competing and learning new things. Meet new
              people and make friends Have a blast competing and learning new
              things
            </p>
          </div>
        </div>
