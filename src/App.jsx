  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          exact
          path="/tournaments/details/:tournamentId/result"
          element={<Result />}
        ></Route>
        <Route
          exact
          path="/tournaments/create"
          element={<OrganiserTournamentForm />}
        ></Route>
        <Route
          exact
        ...
        <Route
          exact
          path="/hostdashboard/manage/:tournamentId/general"
          element={<TournamentManage />}
        ></Route>
        <Route
          exact
          path="/hostdashboard/manage/:tournamentId/participants"
          element={<ParticipantsManage />}
        ></Route>
        <Route
          exact
          path="/hostdashboard/manage/:tournamentId/update"
          element={<TournamentManageUpdate />}
        ></Route>
        <Route
          exact
          path="/hostdashboard/manage/:tournamentId/result"
