...
<div class="flex items-end w-full min-h-screen bg-white -mt-[27rem]">
    ...
    <img src={img} alt="Your Image Alt Text" className="w-48 h-24 bg-black -mt-8" />

                </a>
                <p class="mt-2 text-sm text-gray-500">Ready, Set, Battle!</p>
                <div class="mt-4">
        ...
        <div class="bg-gray-300">
            <div class="container px-5 py-4 mx-auto">
                <p class="text-sm text-gray-700 capitalize text-center xl:text-center">Battle Host © 2023 All rights reserved </p>
            </div>
        </div>
    </footer>
