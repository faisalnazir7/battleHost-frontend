      ...
      <div className="mt-6 flex flex-1 flex-col justify-between">
        <nav className="mx-3 space-y-6 ">
          <div className="space-y-8 flex justify-between md:block">
            <Link to={`/hostdashboard/manage/${tournamentId}/general`}
              className={`flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 ${activeTab==='general'? 'bg-black text-white': 'hover:bg-gray-100 hover:text-gray-700'} `}
            >
            ...
            <Link to={`/hostdashboard/manage/${tournamentId}/participants`}
              className={`flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 ${activeTab==='participants'?'bg-black text-white':'hover:bg-gray-100 hover:text-gray-700'}`}
            >
            ...
            <Link to={`/hostdashboard/manage/${tournamentId}/result`}
              className={`flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 ${activeTab==='result'?'bg-black text-white':'hover:bg-gray-100 hover:text-gray-700'}`}
            >
