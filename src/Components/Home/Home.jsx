...
export default function Home() {
  return (
    ...
    <div className='text-6xl text-white antialiased font-semibold text-left ml-10 text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500 mt-8'><span className='text-transparent text-8xl bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 ml-6 mb-8'>Flaunt </span><br></br>Your Talent!</div>
    ...
    <h3 className='text-white text-4xl ml-24 mt-16 text-red-500'>Register Now</h3>
