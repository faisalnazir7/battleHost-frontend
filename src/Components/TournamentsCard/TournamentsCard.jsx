...
function TournamentsCard({tournament}) {
  return (
    <div className="max-w-sm rounded-2xl overflow-hidden shadow-lg ml-12 mt-12">
  <img className="w-full" src={tournament?.bannerImg?tournament.bannerImg:"https://secure-content.meetupstatic.com/images/classic-events/514351843/676x380.jpg"} />
  <div className="px-6 py-4 bg-white">
    <h2 className="font-bold text-2xl  text-center mb-4">{tournament?.name}</h2>
