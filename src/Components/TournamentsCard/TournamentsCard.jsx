    ...
    <div className="w-80 rounded-2xl border  md:ml-12 mt-12">
      <img
        src={
          tournament?.bannerImg
            ? tournament.bannerImg
            : "https://secure-content.meetupstatic.com/images/classic-events/514351843/676x380.jpg"
        }
        alt="Laptop"
      ...
      <div className="p-4">
        ...
        <span className="flex mb-2">
          ...
          {Date.now() <= endDate ? (
            <img
              src={Live}
              alt="no preview"
              className="ml-auto w-12 h-12 mt-[-1rem]"
            />
          ) : (
            <img
              src={Expired}
        ...
        <span className="flex mb-2">
          ...
          <p className="text-gray-700 text-xs">Registration till</p>
