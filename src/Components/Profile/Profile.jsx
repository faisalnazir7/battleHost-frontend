    ...
    <>
      ...
      <div className="Profile flex">
        ...
        <h1 className="text-3xl mt-4 ml-8 hover:subpixel-antialiased font-sans font-semibold ">Profile</h1>
          <div className="PersonalProfile shadow-md w-[45rem] mt-4 w-[65rem] h-[39rem] rounded-lg grid gap-6 mb-6 md:grid-cols-2 bg-grey-200 ">
            <div className="mb-8 ml-12 mt-12">
            <h1 className="font-sans font-semibold text-xl">Name</h1>
            <h1 className="bg-white w-[39rem] mt-2 rounded-md pl-2 text-lg p-1.5 ">John</h1>
            </div>
            <div className="mb-8 ml-12">
            <h1 className="font-sans font-semibold text-xl">Email</h1>
            <h1 className="bg-white w-[39rem] mt-2 rounded-md pl-2 text-lg p-1.5 ">abc@gmail.com</h1>
            </div>
            <div className="mb-8 ml-12">
            <h3 className="font-sans font-semibold text-xl">Phone Number</h3>
            <h1 className="bg-white w-[39rem] mt-2 rounded-md pl-2 text-lg p-1.5 ">+91 1234567890</h1>
            </div>
            <div className="mb-8 ml-12">
            <h3 className="font-sans font-semibold text-xl">Password</h3>
            <h1 className="bg-white w-[39rem] mt-2 rounded-md pl-2 text-lg p-1.5 ">abc@123*</h1>
            </div>
            </div>
